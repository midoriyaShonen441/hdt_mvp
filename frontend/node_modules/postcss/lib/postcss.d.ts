...
import Node, {
  ...
  ChildProps,
  AnyNode
} from 'postcss/lib/node.jsib/node.js.js'
import Declaration, { DeclarationProps } from 'postcss/lib/declaration.jsaration.js.js'
import Container, { ContainerProps } from 'postcss/lib/container.jsntainer.js.js'
import Document, { DocumentProps } from 'postcss/lib/document.jsocument.js.js'
import Warning, { WarningOptions } from 'postcss/lib/warning.jswarning.js.js'
import Comment, { CommentProps } from 'postcss/lib/comment.jscomment.js.js'
import AtRule, { AtRuleProps } from 'postcss/lib/at-rule.jsat-rule.js.js'
import Input, { FilePosition } from 'postcss/lib/input.jsb/input.js.js'
import Result, { Message } from 'postcss/lib/result.js/result.js.js'
import Root, { RootProps } from 'postcss/lib/root.jsib/root.js.js'
import Rule, { RuleProps } from 'postcss/lib/rule.jsib/rule.js.js'
import CssSyntaxError from 'postcss/lib/css-syntax-error.jsx-error.js.js'
import list, { List } from 'postcss/lib/list.jsib/list.js.js'
import LazyResult from 'postcss/lib/lazy-result.js-result.js.js'
import Processor from 'postcss/lib/processor.jsocessor.js.js'
